...
public final class B64Util{
    ...
    private static final Pattern b64pattern = Pattern.compile("^[a-z0-9A-Z/+]+={1,2}$");
    private B64Util(){}
    /**
     * byte[] Base64 判定.
     * @param array 対象 byte[]
    ...
    public static boolean isBase64(String str){
        ...
        return isBase64(str.getBytes(StandardCharsets.UTF_8)) && b64pattern.matcher(str).matches();
    }
